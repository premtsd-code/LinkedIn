package com.premtsd.linkedin.emailService.consumer;

import com.premtsd.linkedin.connections_service.event.AcceptConnectionRequestEvent;
import com.premtsd.linkedin.emailService.service.SendNotification;
...
public class ConnectionsServiceConsumer {
    ...
    public void handleSendConnectionRequest(com.premtsd.linkedin.connections_service.event.SendConnectionRequestEvent sendConnectionRequestEvent) {
